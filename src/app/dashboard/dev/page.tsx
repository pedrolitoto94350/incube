      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50">
        ...
        <div className="max-w-4xl mx-auto px-4 pt-24 pb-8">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-600 via-teal-600 to-emerald-800 p-8 md:p-12 text-white">
            ...
            <p className="text-emerald-100 mb-8 max-w-md relative">Complète ton profil en 2 minutes pour que les employeurs te trouvent.</p>
            <Link
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50">
      ...
      <div className="max-w-5xl mx-auto px-4 pt-28 pb-12">
            ...
            {skills.length > 0 ? (
              <div className="flex flex-wrap gap-2.5">
                {skills.map((s: string) => (
                  <span
                    key={s}
                    className="px-3.5 py-2 bg-gradient-to-br from-emerald-50 to-teal-50 text-emerald-700 rounded-xl text-sm font-medium shadow-sm border border-emerald-100/50"
                  >
                    {s}
                  </span>
                ))}
        ...
        <div className="sm:hidden grid grid-cols-2 gap-3">
          <Link href="/dashboard/dev/matches" className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 text-white text-sm font-medium">
            🤝 Mes matches
          </Link>
